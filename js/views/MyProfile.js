...
//            console.log(resObj.getAllResponseHeaders());
                if(data.status == "0"){
                    ...
                    $("#basic_info_wrap").html(_.template(this.$el.find("#basic_info_tpl").html())({'basic_infoData':data.menu_info}));
